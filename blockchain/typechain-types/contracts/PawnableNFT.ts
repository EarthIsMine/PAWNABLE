...
export interface PawnableNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface PawnableNFT extends BaseContract {
  connect(runner?: ContractRunner | null): PawnableNFT;
  waitForDeployment(): Promise<this>;

  interface: PawnableNFTInterface;
